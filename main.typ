...
#show: slides.with(
    authors: ([*Jiaxin Huang (Jacky) #super[1]*], [Sarah Meng Li#super[2,3]], [Lia Yeh#super[4,5]], [Aleks Kissinger#super[4]], [Michele Mosca#super[2,3,6]], [Michael Vasmer#super[2,6]]),
    ...
    affiliation: (
      ...
      [Dept. of Combinatorics & Optimization, University of Waterloo (UW)],
...
#slide(title: [Stabilizer codes], footer: [Gottesman, D. (1997). Stabilizer codes and quantum error correction. California Institute of Technology.])[
  ...
  / *(Clifford) Encoders*: #box(baseline: 70%)[#align(center)[#grid(columns: 5, column-gutter: 7pt, row-gutter: 1em)[
    ...
    #only(3)[#place[#image("figs/pte/E.png", width: 9em)]]
...
#new-section[The encoders]

#slide(title: [Encoders as ZX diagrams], footer: [Kissinger, A. (2022). Phase-free ZX diagrams are CSS codes (... or how to graphically grok the surface code). arXiv preprint arXiv:2204.14038.])[
  #show: pause(2)
...
#slide(title: [Lemma: PTE])[
  #image("figs/pte/general.png", width: 21em)
...
#slide(title: "Code morphing", footer: [Vasmer, M., & Kubica, A. (2022). Morphing quantum codes. PRX Quantum, 3(3), 030319.])[
...
#slide(title: "Code morphing")[
  ...
  Given an encoder $E_("parent") $ and a subset $R subset Q$,
    ...
    #alternatives[
      ...
      #image("figs/morph/2367/1.png", width: 8em)][
      #place(dx:3em, dy: 8em)[$E_("parent")$] 
      #place(dx:2em, dy: -1.5em)[#text(purple)[$R={2,3,6,7}$]]
      #image("figs/morph/2367/1.png", width: 8em)][
      #place(dx:2em, dy: -1.5em)[#text(purple)[$R={2,3,6,7}$]]
...
#slide(title: "Steane & quantum Reed-Muller(QRM) code", footer: [Anderson, J. T., Duclos-Cianci, G., & Poulin, D. (2014). Fault-tolerant conversion between the steane and reed-muller quantum codes. Physical review letters, 113(8), 080501.])[
  #table(
...
#slide(title: [Quantum subsystem code], footer: [Kribs, D., Laflamme, R., & Poulin, D. (2005). Unified and generalized approach to quantum error correction. Physical review letters, 94(18), 180501.])[
  ...
  #h(10em)$tilde.eqq angle.l L_1^X, L_1^Z, ..., L_t^X, L_t^Z angle.r < cal(P)_n$
...
#slide(title: [Gauge fixing (QRM $->$ ExSteane)], footer: [Vuillot, C., Lao, L., Criger, B., Almudéver, C. G., Bertels, K., & Terhal, B. M. (2019). Code deformation and lattice surgery are gauge fixing. New Journal of Physics, 21(3), 033028.])[
  #alternatives[
...
#slide(title: [Conclusion & outlook], footer: [Vuillot, C., Lao, L., Criger, B., Almudéver, C. G., Bertels, K., & Terhal, B. M. (2019). Code deformation and lattice surgery are gauge fixing. New Journal of Physics, 21(3), 033028.])[
  #line-by-line[
